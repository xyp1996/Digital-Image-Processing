...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_Jianxian = QtWidgets.QAction(MainWindow)
        self.action_Jianxian.setObjectName("action_Jianxian")
        self.action_Masaike = QtWidgets.QAction(MainWindow)
        self.action_Masaike.setObjectName("action_Masaike")
        ...
        self.action_Hshade = QtWidgets.QAction(MainWindow)
        self.action_Hshade.setObjectName("action_Hshade")
        self.action_Vshade = QtWidgets.QAction(MainWindow)
        self.action_Vshade.setObjectName("action_Vshade")
        ...
        self.menu_4.addAction(self.action_Hshade)
        self.menu_4.addAction(self.action_Vshade)
        ...
        self.effects.addAction(self.action_Jianxian)
        self.effects.addAction(self.menu_4.menuAction())
        self.effects.addAction(self.action_Masaike)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_Jianxian.setText(_translate("MainWindow", "图像渐显"))
        self.action_Masaike.setText(_translate("MainWindow", "马赛克"))
        self.actionshuiping.setText(_translate("MainWindow", "水平栅条"))
        self.actionchuizhi.setText(_translate("MainWindow", "垂直栅条"))
        self.action_Hshade.setText(_translate("MainWindow", "水平百叶窗"))
        self.action_Vshade.setText(_translate("MainWindow", "垂直百叶窗"))
